...
class _DashboardPageState extends State<DashboardPage> {
  ...
  ClientModel? _pendingProposalClient;
  ...
  void _navigateToProposalWithItem(
    ...
    setState(() {
      ...
      _pendingProposalClient = client;
      _pendingRoofStudy = study;
      _activeItem = AppSidebarItem.proposals;
    });
  }
    ...
    switch (_activeItem) {
      case AppSidebarItem.dashboard:
        ...
        if (_currentUser?.isAdmin == true ||
            ...
            _currentUser?.canViewAllProposals == true) {
      ...
      case AppSidebarItem.proposals:
        ...
        return ProposalsView(
          ...
          initialClient: _pendingProposalClient,
          initialRoofStudy: _pendingRoofStudy,
          onClearInitialItem: () => setState(() {
            _pendingProposalItem = null;
            _pendingProposalClient = null;
            _pendingRoofStudy = null;
          }),
        );
      case AppSidebarItem.roofStudies:
        return RoofStudiesView(
          currentUser: _currentUser,
          onProceedToProposal: _navigateToProposalWithItem,
        );
...
class _SuperAdminMasterDashboardState
    extends State<_SuperAdminMasterDashboard> {
  late final AuthRepository _authRepo;
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                children: [
                                  _KpiCard(
                                    ...
                                    isMobile: isMobile,
                                    onTap: () =>
                                        widget.onNavigate(AppSidebarItem.users),
                                  ),
                                  _KpiCard(
                                    title: 'TOTAL DE USUÁRIOS',
                                    value: '${users.length}',
                                    subtitle:
                                        '${users.length - adminsCount} operadores vinculados',
                                  ...
                                  _KpiCard(
                                    ...
                                    isMobile: isMobile,
                                    onTap: () => widget
                                        .onNavigate(AppSidebarItem.proposals),
                                  ),
                                  _KpiCard(
                                  ...
                                  _KpiCard(
                                    ...
                                    isMobile: isMobile,
                                    onTap: () => widget
                                        .onNavigate(AppSidebarItem.clients),
                                  ),
                                  _KpiCard(
                                    ...
                                    isMobile: isMobile,
                                    onTap: () => widget
                                        .onNavigate(AppSidebarItem.products),
                                  ),
                                ],
                              ),
                              ...
                              if (isMobile) ...[
                                ...
                                _RecentClientsAuditCard(
                                  clients: clients,
                                  onViewAll: () =>
                                      widget.onNavigate(AppSidebarItem.clients),
                                ),
                              ] else ...[
                                Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Expanded(
                                      ...
                                      child: _RecentProposalsAuditCard(
                                        proposals: proposals,
                                        onViewAll: () => widget.onNavigate(
                                            AppSidebarItem.proposals),
                                      ),
                                    ),
...
class _CompanyExecutiveDashboard extends StatefulWidget {
  ...
  @override
  State<_CompanyExecutiveDashboard> createState() =>
      _CompanyExecutiveDashboardState();
}

class _CompanyExecutiveDashboardState
    extends State<_CompanyExecutiveDashboard> {
  late final AuthRepository _authRepo;
  late final ProposalRepository _proposalRepo;
  late final ProductRepository _productRepo;
  late final ContractRepository _contractRepo;
                  ...
                  builder: (context, contSnap) {
                    return StreamBuilder<List<ClientModel>>(
                      ...
                      builder: (context, clientSnap) {
                        ...
                        final totalRevenue = proposals.fold<double>(
                            0.0, (acc, p) => acc + p.totalAmount);
                        final closedProposals = proposals
                            .where((p) => p.status == ProposalStatus.closed)
                            .toList();
                        final closedRevenue = closedProposals.fold<double>(
                            0.0, (acc, p) => acc + p.totalAmount);
                        final conversionRate = proposals.isEmpty
                            ? 0.0
                            : (closedProposals.length / proposals.length) * 100;
                        final solarPlants = products
                            .where((p) =>
                                p.sector == ProductSector.solarPlant ||
                                p.isSolarPlantKit)
                            .toList();
                        final totalKwp = solarPlants.fold<double>(
                            0.0, (acc, p) => acc + (p.solarKilowatts ?? 0.0));
                              ...
                              Wrap(
                                ...
                                children: [
                                  _KpiCard(
                                    ...
                                    subtitle:
                                        '${closedProposals.length} propostas ganhas',
                                  ...
                                  _KpiCard(
                                    ...
                                    subtitle:
                                        '${proposals.length} orçamentos emitidos',
                                  ...
                                  _KpiCard(
                                    ...
                                    subtitle:
                                        '${solarPlants.length} usinas solares no catálogo',
                                    icon: Icons.solar_power_rounded,
                                    color: const Color(0xFFF59E0B),
                                    isMobile: isMobile,
                                    onTap: () => widget
                                  ...
                                  _KpiCard(
                                    ...
                                    subtitle:
                                        '${signedContracts.length} assinados / fechados',
                                    icon: Icons.gavel_rounded,
                                    color: const Color(0xFF8B5CF6),
                                    isMobile: isMobile,
                                    onTap: () => widget
                                        .onNavigate(AppSidebarItem.contracts),
                                  ),
                                  _KpiCard(
...
class _TeamPerformanceRankingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<_UserSellerStats> statsList = users.map((u) {
      final userProps = proposals
          .where((p) =>
              p.createdByUserId == u.uid ||
              (p.createdByUserId == null && p.createdByUserName == u.name))
          .toList();
      final userClosed =
          userProps.where((p) => p.status == ProposalStatus.closed).toList();
      final userProducts = products
          .where((p) =>
              p.createdByUserId == u.uid ||
              (p.createdByUserId == null && p.createdByUserName == u.name))
          .toList();
      final userSolar = userProducts
          .where(
              (p) => p.sector == ProductSector.solarPlant || p.isSolarPlantKit)
          .toList();
      final userContracts = contracts
          .where((c) =>
              c.createdByUserId == u.uid ||
              (c.createdByUserId == null && c.createdByUserName == u.name))
          .toList();

      final totalPropsVal =
          userProps.fold<double>(0.0, (acc, p) => acc + p.totalAmount);
      final closedVal =
          userClosed.fold<double>(0.0, (acc, p) => acc + p.totalAmount);
      final totalKwp = userSolar.fold<double>(
          0.0, (acc, p) => acc + (p.solarKilowatts ?? 0.0));
      final conversion = userProps.isEmpty
          ? 0.0
          : (userClosed.length / userProps.length) * 100;
              ...
              child: ConstrainedBox(
                ...
                child: DataTable(
                  ...
                  columns: [
                    ...
                    DataColumn(
                        label:
                            Text('VENDEDOR / OPERADOR', style: _headerStyle())),
                    DataColumn(
                        label: Text('PROPOSTAS (R\$)', style: _headerStyle())),
                    DataColumn(
                        label: Text('VENDAS GANHAS', style: _headerStyle())),
                      ...
                      cells: [
                        ...
                        DataCell(
                          Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(currency.format(s.proposalsTotalValue),
                                  style: GoogleFonts.outfit(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 12.5,
                                      color: const Color(0xFF0F172A))),
                              Text('${s.proposalsCount} orçamentos',
                                  style: GoogleFonts.inter(
                                      fontSize: 10.5,
                                      color: const Color(0xFF64748B))),
                            ],
                        ...
                        DataCell(
                          Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(currency.format(s.closedTotalValue),
                                  style: GoogleFonts.outfit(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 12.5,
                                      color: const Color(0xFF10B981))),
                              Text('${s.closedCount} ganhas',
                                  style: GoogleFonts.inter(
                                      fontSize: 10.5,
